...
import { Shield, Award, AlertTriangle, ExternalLink, Search } from "lucide-react";
    ...
    <MainLayout>
      ...
      <section className="pt-6 pb-24 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-8">
            <div className="relative flex-1 max-w-md">
              ...
              <input type="text" value={search} onChange={e => setSearch(e.target.value)}
                placeholder="Search brokers..." className="w-full pl-10 pr-4 py-2.5 bg-card border border-border rounded-lg text-sm text-foreground placeholder:text-muted-foreground outline-none focus:border-primary/40" />
            </div>
          ...
          {filtered.length === 0 && <p className="text-center text-muted-foreground py-12">No brokers found.</p>}
        </div>
      </section>
    </MainLayout>
  );
